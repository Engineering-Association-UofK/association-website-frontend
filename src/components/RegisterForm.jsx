  ...
  return (
    <div className="min-h-screen bg-[#fcfdfb] flex items-center justify-center p-4 ">
      <div className="max-w-2xl w-full bg-white rounded-[30px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12">
        ...
        >
          {/* المرحلة الأولى: البيانات الجامعية */}
          {step === 1 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className={labelStyles}>Student Index</label>
                  <input
                    type="number"
                    name="user_id"
                    required
                ...
                <div>
                  <label className={labelStyles}>University ID</label>
                  <input
                    type="number"
                    name="uni_id"
                    required
              ...
              <div>
                <label className={labelStyles}>Passcode</label>
                <input
                  type="text"
                  name="passcode"
                  required
          ...
          {/* المرحلة الثانية: البيانات الشخصية والحساب */}
          {step === 2 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className={labelStyles}>Full Name (EN)</label>
                  <input
                    type="text"
                    name="name_en"
                    required
